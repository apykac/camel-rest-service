...
/**
 * Предназначен для подключения к адаптируемому сервису, использует передачу через REST точки. Реализованно передача данных
 * через POST запрос
 */
@Component
public class MicroserviceBClient implements Processor, RestClient {
    private final RestTemplate restTemplate;
    /** полный урл адаптируемого сервиса */
